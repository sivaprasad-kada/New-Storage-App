...
const Header = () => {
    ...
    return (
        <header className="h-20 px-4 sm:px-8 flex items-center justify-between shrink-0 bg-gray-50 dark:bg-slate-900 border-b border-transparent transition-colors duration-300">
            ...
            {/* Actions & User Menu */}
            <div className="flex items-center gap-3 sm:gap-6 shrink-0 relative" ref={userMenuRef}>
                <div className="relative cursor-pointer hover:bg-gray-100 dark:hover:bg-slate-800 p-2 rounded-full transition-colors">
