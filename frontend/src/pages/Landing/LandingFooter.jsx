      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-14 grid grid-cols-2 md:grid-cols-6 gap-8">
          ...
          <div className="col-span-2">
            <Link to="/" className="flex items-center gap-2.5 mb-5">
              ...
              <span className="text-[1.15rem] font-bold text-white tracking-tight">
                Cloud<span className="text-sky-400">Vault</span>
              </span>
            </Link>
            <p className="text-[0.85rem] text-slate-400 leading-relaxed max-w-xs mb-6">
              Secure cloud storage and file sharing platform built for individuals and teams who value speed, privacy, and simplicity.
            </p>
            {/* Social Links */}
          ...
          {Object.entries(footerLinks).map(([category, links]) => (
            <div key={category}>
              <p className="text-[0.75rem] font-semibold text-slate-300 uppercase tracking-wider mb-4">
                {category}
              </p>
                ...
                {links.map((link) => (
                  <li key={link.label}>
                    <a
                      ...
                      className="text-[0.85rem] text-slate-400 hover:text-white transition-colors duration-200"
                    >
                      {link.label}
                    </a>
                  </li>
