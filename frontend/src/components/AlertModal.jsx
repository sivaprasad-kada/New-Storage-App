...
const AlertModal = ({
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-sm p-4 transition-opacity animate-in fade-in duration-200">
            <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl w-full max-w-sm border border-gray-200 dark:border-slate-800 transform scale-100 animate-in zoom-in-95 duration-200">
                {/* Header */}
                ...
                <div className="p-6 pt-0 flex gap-3">
                    <button
                        onClick={onClose}
                        className={`w-full py-3 px-4 font-bold text-white rounded-xl shadow-lg transition-transform active:scale-95 ${isDanger
